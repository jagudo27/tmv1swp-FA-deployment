...
class TrendMicroEventTransformer:
    ...
    def _map_identifiers_and_metadata(self, raw_event: Dict, transformed_event: Dict) -> None:
        ...
        transformed_event["eventId"] = raw_event.get("eventId")
        transformed_event["eventTime"] = raw_event.get("detectedDateTime") or raw_event.get("eventTime")
        transformed_event["pname"] = raw_event.get("pname") or raw_event.get("productCode")
        ...
        transformed_event["filterRiskLevel"] = highest_risk_filter.get('riskLevel') if highest_risk_filter else None
    ...
    def _map_endpoint_information(self, raw_event: Dict, transformed_event: Dict) -> None:
        ...
        transformed_event["endpointHostName"] = self._extract_endpoint_hostname(raw_event)
        transformed_event["endpointIp"] = self._extract_endpoint_ip_address(raw_event)
    ...
    def _map_process_information(self, raw_event: Dict, transformed_event: Dict) -> None:
        ...
        transformed_event["processCmd"] = event_detail.get("processCmd") or event_detail.get("cmd") or event_detail.get("commandLine")
        transformed_event["processFilePath"] = event_detail.get("processFilePath") or event_detail.get("filePath") or event_detail.get("processPath")
        transformed_event["processName"] = event_detail.get("processName") or event_detail.get("process") or event_detail.get("fname")
        
        # Handle PID - could be string or int
        pid = event_detail.get("processPid") or event_detail.get("pid")
        if pid is not None:
            transformed_event["processPid"] = str(pid)
            
        transformed_event["processUser"] = event_detail.get("processUser") or event_detail.get("user")
        transformed_event["processUserDomain"] = event_detail.get("processUserDomain") or event_detail.get("userDomain")
    ...
    def _map_object_information(self, raw_event: Dict, transformed_event: Dict) -> None:
        ...
        transformed_event["objectFilePath"] = event_detail.get("objectFilePath") or event_detail.get("objectPath") or event_detail.get("targetFilePath")
        transformed_event["objectName"] = event_detail.get("objectName") or event_detail.get("objectFile") or event_detail.get("targetFileName")
        ...
        transformed_event["objectLaunchTime"] = event_detail.get("objectLaunchTime") or event_detail.get("accessTime") or event_detail.get("execTime")
